...
public class Tree {
    ...
    private TreeNodeNode delete(TreeNodeNode subtreeRoot, int value) {
        ...
        if (value < subtreeRoot.getData()) {
            ...
            // 1) Replace the value in the subtreeRoot with the smallest value from the right subtree
            subtreeRoot.setData(subtreeRoot.getRightChild().min());
            // 2) Delete the node that has the smallest value in the right subtree
